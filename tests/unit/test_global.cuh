...
// Not I get wierd linking errors with external globla memory when trying to compile
// these tests.
// A solution is to use getter functions . . . need to see how this can be done
