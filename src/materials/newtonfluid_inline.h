...
stress_update_newtonfluid(Matrix3r *particles_stresses_gpu,
                          ...
                          const Real viscosity, const Real bulk_modulus,
...
__global__ void KERNEL_STRESS_UPDATE_NEWTONFLUID(
  ...
  stress_update_newtonfluid(
      ...
      particles_volumes_original_gpu, particles_colors_gpu, viscosity,
      bulk_modulus, gamma, mat_id, tid);
}
