#include "pyroclastmpm/materials/elastoplastic/elastoplasticmat.cuh"
...
namespace pyroclastmpm
{
   ...
   */
  Elastoplastic::Elastoplastic(const Real _density,
                               const Real _E,
                               const Real _pois,
  ...
  void Elastoplastic::stress_update(ParticlesContainer &particles_ref,
                                    int mat_id)
  {
   ...
   * @param dim dimension
   */
  void Elastoplastic::outbound_stress_update(Matrix3r &stress,
                                             Matrix3r &Eps_p,
                                             Real &logJp,
